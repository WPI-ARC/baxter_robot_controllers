...
int main(int argc, char** argv)
{
    ...
    ros::NodeHandle nh;
    ros::NodeHandle nhp("~");
    const std::string DEFAULT_TARGET_CONFIG_TOPIC = "baxter_right_arm_position_controller/target";
    ...
    const std::string DEFAULT_JOINT_COMMAND_TOPIC = "/robot/limb/right/joint_command_raw";
