...
int main(int argc, char** argv)
{
    ...
    ros::NodeHandle nh;
    ros::NodeHandle nhp("~");
    const std::string DEFAULT_TARGET_VELOCITY_TOPIC = "/robot/limb/left/joint_command_raw";
    const std::string DEFAULT_CONFIG_FEEDBACK_TOPIC = "/robot/joint_states";
    const std::string DEFAULT_JOINT_COMMAND_TOPIC = "/robot/limb/left/joint_command";
