...
int main(int argc, char** argv)
{
    ...
    ros::NodeHandle nh;
    ros::NodeHandle nhp("~");
    const std::string DEFAULT_TARGET_CONFIG_TOPIC = "/robot/limb/left/joint_command_position";
    ...
    nhp.param(std::string("position_command_topic"), target_config_topic, DEFAULT_TARGET_CONFIG_TOPIC);
    ...
    baxter_robot_controllers::BaxterRobotPositionController controller(nh, target_config_topic, config_feedback_topic, velocity_command_topic, status_topic, abort_service, joint_limits, joint_controller_params);
